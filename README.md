...
This repository contains a GitHub Actions workflow that automatically pings your ServiceNow Personal Developer Instance (PDI) every 2 hours to prevent it from hibernating due to inactivity (with a pause for Shabbat - from Friday 13:00 to Saturday 21:00 Israel Time).
...
That's it! GitHub Actions will now run the workflow automatically every 2 hours (excluding Shabbat) to keep your instance awake forever.
