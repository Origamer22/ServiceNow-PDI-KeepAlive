...
This repository contains a GitHub Actions workflow that automatically pings your ServiceNow Personal Developer Instance (PDI) every 1 hour to prevent it from hibernating due to inactivity (with a pause for Shabbat - from Friday 13:00 to Saturday 21:00 Israel Time).
...
## Features
- **1-Hourly Ping:** A lightweight curl request is sent to your PDI every 1 hour to keep it awake.
...
That's it! GitHub Actions will now run the workflow automatically every 1 hour (excluding Shabbat) to keep your instance awake forever.
